  // -*- C++ -*-
  //
  // Package:    CNNFiltering/CNNTrackDump
  // Class:      CNNTrackDump
  //
  /**\class CNNTrackDump CNNTrackDump.cc CNNFiltering/CNNTrackDump/plugins/CNNTrackDump.cc
  ...
  */
  ...
  class CNNTrackDump : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
  public:
    explicit CNNTrackDump(const edm::ParameterSet&);
    ~CNNTrackDump();
  ...
  void
  CNNTrackDump::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
  {
    using namespace edm;
  ...
  void
  CNNTrackDump::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
  ...
  DEFINE_FWK_MODULE(CNNTrackDump);
