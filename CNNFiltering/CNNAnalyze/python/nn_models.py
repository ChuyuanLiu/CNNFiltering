...
kfoldindices_val   = indices[:sizesamp] if not args.debug else  [indices[0]]
...
train_files = np.take(the_files,kfoldindices_train) #train_files[kfoldindices_train,:] #np.take(train_files,kfoldindices_train)
test_files = np.take(the_files,kfoldindices_test) #train_files[kfoldindices_test,:]
val_files = np.take(the_files,kfoldindices_val) #train_files[kfoldindices_val,:]
...
models = ["dense_model","separate_conv_model","layer_map_model","conv_model"]
