...
# pixelPairStepCNN = cms.EDAnalyzer('CNNInferenceAOT',
...
# jetCoreRegionalStepCNN = cms.EDAnalyzer('CNNInferenceAOT',
#         processName = cms.string( "pixelPairStepHitDoublets"),
#         doublets    = cms.InputTag( "pixelPairStepHitDoublets" ),
#         tpMap       = cms.InputTag( "tpClusterProducer" ),
#         beamSpot    = cms.InputTag("offlineBeamSpot"),
...
detachedQuadStepCNN = cms.EDAnalyzer('CNNInferenceAOT',
...
highPtTripletStepCNN = cms.EDAnalyzer('CNNInferenceAOT',
...
detachedTripletStepCNN = cms.EDAnalyzer('CNNInferenceAOT',
...
# initialStepPreSplittingCNN = cms.EDAnalyzer('CNNInferenceAOT',
...
initialStepCNN = cms.EDAnalyzer('CNNInferenceAOT',
...
lowPtQuadStepCNN = cms.EDAnalyzer('CNNInferenceAOT',
...
lowPtTripletStepCNN = cms.EDAnalyzer('CNNInferenceAOT',
...
mixedTripletStepACNN = cms.EDAnalyzer('CNNInferenceAOT',
...
mixedTripletStepBCNN = cms.EDAnalyzer('CNNInferenceAOT',
...
pixelLessStepCNN = cms.EDAnalyzer('CNNInferenceAOT',
...
tobTecStepCNN = cms.EDAnalyzer('CNNInferenceAOT',
...
tripletElectronCNN = cms.EDAnalyzer('CNNInferenceAOT',
...
CNNInferenceAOTSequence = cms.Sequence(detachedQuadStepCNN *
