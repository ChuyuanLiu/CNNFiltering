#ifndef JpsiPhiAnalysis_TrackProducer_TrackProducerPAT_h
#define JpsiPhiAnalysis_TrackProducer_TrackProducerPAT_h
...
class TrackProducerPAT : public edm::EDProducer {
 public:
  explicit TrackProducerPAT(const edm::ParameterSet&);
  ~TrackProducerPAT() override;
