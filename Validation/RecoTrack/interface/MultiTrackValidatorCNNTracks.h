#ifndef MultiTrackValidatorCNNTracks_h
#define MultiTrackValidatorCNNTracks_h

/** \class MultiTrackValidatorCNNTracks
...
class MultiTrackValidatorCNNTracks : public DQMEDAnalyzer {
 public:
  /// Constructor
  MultiTrackValidatorCNNTracks(const edm::ParameterSet& pset);

  /// Destructor
  ~MultiTrackValidatorCNNTracks() override;
