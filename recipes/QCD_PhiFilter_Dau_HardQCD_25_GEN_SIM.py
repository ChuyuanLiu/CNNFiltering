...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('QCD_PhiFilter_Dau_HardQCD_25_GEN_SIM.root'),
...
process.kkgenfilter = cms.EDFilter("MCParticlePairFilter",
    MaxEta = cms.untracked.vdouble(2.5, 2.5),
    MaxInvMass = cms.untracked.double(1.15),
    MinEta = cms.untracked.vdouble(-2.5, -2.5),
    MinInvMass = cms.untracked.double(0.95),
    MinP = cms.untracked.vdouble(0.0, 0.0),
    MinPt = cms.untracked.vdouble(0.8, 0.8),
    ParticleCharge = cms.untracked.int32(-1),
...
process.ProductionFilterSequence = cms.Sequence(process.generator+process.phifilter+process.kkgenfilter)
