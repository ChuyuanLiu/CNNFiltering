...
void HitPairGeneratorFromLayerPair::doublets(const TrackingRegion& region,
  ...
  int inLay  = (int)(find(pixelDets.begin(),pixelDets.end(),innerLayer->seqNum()) - pixelDets.begin());
  int outLay = (int)(find(pixelDets.begin(),pixelDets.end(),outerLayer->seqNum()) - pixelDets.begin());
