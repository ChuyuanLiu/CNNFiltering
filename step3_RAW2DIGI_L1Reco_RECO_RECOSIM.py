...
# with command line options: step3 --conditions auto:phase1_2018_realistic -n 10 --era Run2_2018 --eventcontent RECOSIM --step RAW2DIGI,L1Reco,RECO,RECOSIM --datatier GEN-SIM-RECO --filein file:step2.root --fileout file:step3.root --no_exec
